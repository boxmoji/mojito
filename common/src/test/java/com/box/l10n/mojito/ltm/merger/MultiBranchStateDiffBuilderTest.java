...
public class MultiBranchStateDiffBuilderTest {
    ...
    static Logger logger = LoggerFactory.getLogger(MultiBranchStateDiffBuilderTest.class);
    ...
    public void mergeCurrentIntoBaseAndCreateTextUnits() {
        ...
        logger.debug(objectMapper.writeValueAsStringUnchecked(merged));
        ...
        logger.debug("-------- building merged2");
        logger.debug("merged: " + objectMapper.writeValueAsStringUnchecked(merged));
        logger.debug("current2: " + objectMapper.writeValueAsStringUnchecked(current2));
        ...
        logger.debug(objectMapper.writeValueAsStringUnchecked(merged2));
        ...
        logger.debug("-------- building merged3");
        logger.debug("merged2: " + objectMapper.writeValueAsStringUnchecked(merged2));
        logger.debug("current3: " + objectMapper.writeValueAsStringUnchecked(current3));
        ...
        logger.debug(objectMapper.writeValueAsStringUnchecked(merged3));
